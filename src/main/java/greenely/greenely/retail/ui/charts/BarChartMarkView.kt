...
class BarChartMarkView(context: Context, layoutResource: Int) : MarkerView(context, layoutResource) {
    ...
    override fun refreshContent(e: Entry?, highlight: Highlight?) {
        ...
        if (e is CandleEntry) {
            ...
            if (e != null) {
                tvContent.text = Utils.formatNumber(e.y / 100, 1, false) + " kr | " + formattedDate?.let { getDateTime(it) }
            }
        }
